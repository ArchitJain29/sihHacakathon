...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndGet([bool filter = false]) async {
    try {
      ...
      // String filterString = "";
      var url =
          'https://hackathon-cb88d-default-rtdb.firebaseio.com/products.json?auth=$_authToken&$filterString';
      ...
      log('3');
      url =
          'https://hackathon-cb88d-default-rtdb.firebaseio.com/userFavorite/$_userId.json?auth=$_authToken';
      log('4');
  ...
  Future<void> addProduct(Product product) async {
    log('add hua h');
    final url =
        'https://hackathon-cb88d-default-rtdb.firebaseio.com/products.json?auth=$_authToken';
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    // log('update hua h');
    final url =
        'https://hackathon-cb88d-default-rtdb.firebaseio.com/products/$id.json?auth=$_authToken';
  ...
  Future<void> deleteProduct(String productId) async {
    final url =
        'https://hackathon-cb88d-default-rtdb.firebaseio.com/products/$productId.json?auth=$_authToken';
    try {
